  ...
  methods: {
    ...
    async getAwaitReq() {
      const requests = await this.$axios.get(
        `/api/Admin/AdminManageVisitor/GetAllSettlementRequests?status=0`,
        {
          headers: {
    ...
    async getRejected() {
      const requests = await this.$axios.get(
        `/api/Admin/AdminManageVisitor/GetAllSettlementRequests?status=3`,
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
          },
    ...
    async getInPayList() {
      const requests = await this.$axios.get(
        `/api/Admin/AdminManageVisitor/GetAllSettlementRequests?status=1`,
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
          },
    ...
    async getPayed() {
      const requests = await this.$axios.get(
        `/api/Admin/AdminManageVisitor/GetAllSettlementRequests?status=2`,
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
          },
    ...
    async searchEvent(id) {
      ...
      const requests = await this.$axios.get(
        `/api/Admin/AdminManageVisitor/GetAllSettlementRequests?search=${this.searchInput}&status=${id}`,
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
          },

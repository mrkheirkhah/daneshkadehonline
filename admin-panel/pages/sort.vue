<template>
  <div class="assortment">
    <div class="panel-admin-content-item assortment">
      <header>
        <p class="section-header">دسته بندی</p>
      </header>
      ...
      <form action="">
        ...
        <div class="section-title">
          ...
          <p class="section-title-text">افزودن گروه دوره</p>
        </div>
        <div class="form-row">
          <label for="" class="form-row-col">
            <input
  ...
  methods: {
    ...
    async setSelectTwo(event, id) {
      ...
      const groupsResp = await this.$axios.get(
        `/api/Admin/AdminGroup/GetCourseGroups/${id}`,
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
          },
    ...
    async submitFristRow() {
      if (this.buttonForEdit == false) {
        const firstRowResp = await this.$axios.post(
          `/api/Admin/AdminGroup/CourseGroup?groupTitle=${this.firstRowText}`,
          {},
          {
            headers: {
              Authorization: `Bearer ${this.$cookies.get("key")}`,
        ...
        const editGroupResp = await this.$axios.put(
          `/api/Admin/AdminGroup/CourseGroup?groupId=${this.editThisId}&groupTitle=${this.firstRowText}`,
          {},
          {
            headers: {
              Authorization: `Bearer ${this.$cookies.get("key")}`,
    ...
    async submitSecondRow() {
      const secondRowResp = await this.$axios.post(
        `/api/Admin/AdminGroup/CourseGroup?groupTitle=${this.secondRowText}&parentId=${this.selectTwoId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
      ...
      if (
        ...
        this.getGroups();
        const groupsResp = await this.$axios.get(
          `/api/Admin/AdminGroup/GetCourseGroups/${this.selectTwoId}`,
          {
            headers: {
              Authorization: `Bearer ${this.$cookies.get("key")}`,
            },
    ...
    async submitThirdRow() {
      const thirdRowResp = await this.$axios.post(
        `/api/Admin/AdminGroup/CourseGroup?groupTitle=${this.thirdRowText}&parentId=${this.selectFourId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
    ...
    async getGroups() {
      const groupsResp = await this.$axios.get("/api/Admin/AdminGroup/GetCourseGroups", {
        headers: {
          Authorization: `Bearer ${this.$cookies.get("key")}`,
        },
      });
    ...
    async deleteGroup(id) {
      const deleteResp = await this.$axios.delete(
        `/api/Admin/AdminGroup/CourseGroup/${id}`,
        {
          headers: {
            Authorization: `Bearer ${this.$cookies.get("key")}`,
          },

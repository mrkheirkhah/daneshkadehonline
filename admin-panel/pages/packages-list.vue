  ...
  methods: {
    ...
    async getPackReqs() {
      const packReqsResponse = await this.$axios.get(
        `/api/Admin/AdminManageTeacher/GetTeacherPackageRequest`,
        {
          headers: {
    ...
    async searchEvent() {
      ...
      if (this.selectedFilter == "") {
        const packReqsResponse = await this.$axios.get(
          `/api/Admin/AdminManageTeacher/GetTeacherPackageRequest?search=${this.searchInput}`,
          {
            headers: {
              Authorization: `Bearer ${this.$cookies.get("key")}`,
            },
        ...
        const packReqsResponse = await this.$axios.get(
          `/api/Admin/AdminManageTeacher/GetTeacherPackageRequest?search=${this.searchInput}&acceptFilter=${this.selectedFilter}`,
          {
            headers: {
              Authorization: `Bearer ${this.$cookies.get("key")}`,
            },
  ...
  watch: {
    selectedFilter: {
      async handler() {
        if (this.searchInput == "") {
          const packReqsResponse = await this.$axios.get(
            `/api/Admin/AdminManageTeacher/GetTeacherPackageRequest?acceptFilter=${this.selectedFilter}`,
            {
              headers: {
                Authorization: `Bearer ${this.$cookies.get("key")}`,
              },

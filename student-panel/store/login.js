...
export const actions = {
    setLoginDetails({ commit },resp){
        const phoneNumber = resp.data.data.phoneNumber
        const studentName = resp.data.data.studentName
        commit('SET_LOGIN_DETAILS',{name : studentName , phone :phoneNumber})
    ...
    setRegisterData({ commit },resp){
        ...
        const studentName = resp.data.studentName
        commit('SET_LOGIN_DETAILS',{name : studentName , phone :phoneNumber})

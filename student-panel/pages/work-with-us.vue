...
export default {
  head() {
    return {
      title: "فرصت استثنایی همکاری در تولید محتوا آموزشی | دانشکده آنلاین",
      meta: [
        {
          hid: "description",
          content:
            "برای همکاری در تولید محتوا آموزشی و یا برگذاری کلاس های آنلاین در پلتفرم اشتراکی دانشکده آنلاین ، فقط کافیست تا در این صفحه ثبت نام کنید و سپس فرم درخواست همکاری را تکمیل کنید - دسترسی به تمام پارسی زبانان در هر جای دنیا - ما صدای شما را به گوش همگان میرسانیم | دانشکده انلاین",
        },
      ],
    };
  },
